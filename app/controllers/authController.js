...
exports.generateQRTwoFactor = function(req, res) {
  util.logConsole(0,'Auth/generateQRTwoFactor');
  util.logConsole(1,req.query);
  session.verifyToken(req, res, function() {
    Auth.generateQRTwoFactor(
      req.query['usrId'],
      req.query['email'],
      function(task) {
        util.logConsole(3,task);
...
exports.verifyCodeTwoFactor = function(req, res) {
  util.logConsole(0,'Auth/verifyCodeTwoFactor');
  util.logConsole(1,req.query);
  session.verifyToken(req, res, function() {
    Auth.verifyCodeTwoFactor(
      req.query['usrId'],
      req.query['token'],
      function(task) {
        util.logConsole(3,task);
...
exports.validateCodeTwoFactor = function(req, res) {
  util.logConsole(0,'Auth/validateCodeTwoFactor');
  util.logConsole(1,req.query);
  session.verifyToken(req, res, function() {
    Auth.validateCodeTwoFactor(
      req.query['usrId'],
      req.query['token'],
      function(task) {
        util.logConsole(3,task);
